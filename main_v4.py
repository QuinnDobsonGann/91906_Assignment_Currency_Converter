...
class Converter:
    """
    Currency conversion tool (NZD to either USD, CAD and AUD)
    """
    ...
    def __init__(self):
        ...
        button_details_list = [
            ["To USD", "#990099", partial(self.check_currency, 1), 0, 0],
            ["To CAD", "#009900", partial(self.check_currency, 1), 0, 1],
            ["To GBP", "#909900", partial(self.check_currency, 1), 0, 2],
    ...
    def convert(self, min_currency, to_convert):
        if min_currency:
            ...
            answer_statement = f"{to_convert}NZD is {answer}CAD"  # Fixed parentheses here
