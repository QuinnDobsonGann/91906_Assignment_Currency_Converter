...
class Converter:
    ...
    def __init__(self):
        ...
        button_details_list = [
            # Top buttons
            ["To USD", "#990099", partial(self.check_currency, 1), self.top_button_frame, 0, 0],
            ["To CAD", "#009900", partial(self.check_currency, 1), self.top_button_frame, 0, 1],
            ["To GBP", "#909900", partial(self.check_currency, 1), self.top_button_frame, 0, 2],
    ...
    def check_currency(self, min_currency):
        ...
        # checks if input has more than 20 digits (count digits only)
    ...
    def convert(self, min_currency, to_convert):
        if min_currency:
            ...
            answer_statement = f"{to_convert}NZD is {answer}CAD"

        # shows currency conversion underneath box.
